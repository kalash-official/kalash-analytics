...
body{display:flex;background:#f5f7fb;}
...
.sidebar ul li{padding:12px;cursor:pointer;border-radius:8px;}
...
<div class="main">
  ...
  <div class="navbar">
    ...
    <div class="icon">
      📥
      <span class="badge-count" id="queueBadge">0</span>
    </div>
  </div>
